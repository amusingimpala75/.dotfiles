...
in {
  ...
  config = lib.mkIf enable {
    home.activation.set-wallpaper = lib.mkIf cfg.wallpaper.enable (lib.hm.dag.entryAfter ["writeBoundary"] ''
    ...
    home.activation.cp-wezterm = lib.mkIf (config.programs.wezterm.enable && cfg.wezterm.enable) (lib.hm.dag.entryAfter ["writeBoundary"] ''
