...
(use-package cape
  ...
  (setq my/eglot-capf (cape-capf-super #'eglot-completion-at-point #'cape-abbrev)
        ...
        my/org-capf (cape-capf-super #'cape-abbrev #'cape-elisp-block #'ispell-completion-at-point)
        my/generic-capf (cape-capf-super #'cape-abbrev #'ispell-completion-at-point))
